...
class MettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metting" do
    assert_difference("Metting.count") do
      post mettings_url, params: { metting: { end_time: @metting.end_time, name: @metting.name, start_time: @metting.start_time, user_id: @metting.user_id } }
    end
  ...
  test "should update metting" do
    patch metting_url(@metting), params: { metting: { end_time: @metting.end_time, name: @metting.name, start_time: @metting.start_time, user_id: @metting.user_id } }
